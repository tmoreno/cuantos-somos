...
@Path("/getnumeropersonas")
public class GetNumeroPersonas {
	
	private final Logger logger = LoggerFactory.getLogger(GetNumeroPersonas.class);
	
	@GET
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public String getNumeroPersonas(@QueryParam("p") String json) {
		Connection con = null;
		...
		try {			
			...
			GetNumeroPersonasOperacion operacion = 
				new GetNumeroPersonasOperacion(parametros);
